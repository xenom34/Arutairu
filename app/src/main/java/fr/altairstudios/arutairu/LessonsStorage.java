...
class LessonsStorage {
    ...
    LessonsStorage() {
        ...
        storage.put(KATAKANA, new Lesson(R.array.katakanaJP, R.array.katakanaRM, R.array.katakanaFR));
        storage.put(DAKUTENKATA, new Lesson(R.array.dukutenKataJP, R.array.dakutenRM, R.array.dakutenFR));
